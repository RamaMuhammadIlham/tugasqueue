...
void menu()
{
    ...
    do{
        ...
        {
        case 1:
            cout << "Masukkan nomor antrian: ";cin>>angka;
            enqueue(angka);
            cout << "\n\n\n";
            break;
        case 2:
            cout << "Antrian ke : " << dequeue() << " selesai" << endl;
            cout << "\n\n\n";
            break;
        case 3:
            if (isEmpty()!=true)
        ...
        case 4:
            ...
            else if(isEmpty())
            {
                ...
                cout << "Ada isinya tetapi tidak penuh" << endl;
                cout << "\n\n";
            }
            break;
        case 5:
